...
class EncounteredPapersGeneral:
    ...
    def __init__(self, dataset_name, max_number_sections):
        ...
        self.papers_data.update({'paper_number': []})
        self.papers_data.update({'paper_counter': []})
        self.papers_data.update({'paper_session': []})
        self.papers_data.update({'paper_proceeding': []})
        self.papers_data.update({'keyword': []})
    ...
    def add_full_datapoint(self, paper_name, paper_number, paper_counter, session_name, proceedings_year, keyword): #, sections, references):
        self.papers_data['paper_name'].append(paper_name)
        self.papers_data['paper_number'].append(paper_number)
        self.papers_data['paper_counter'].append(paper_counter)
        self.papers_data['paper_session'].append(session_name)
        self.papers_data['paper_proceeding'].append(proceedings_year)
        self.papers_data['keyword'].append(keyword)
