 ...
 #                   Extract_Data.append([Font_size, (element.get_text())])
    ...
    def load_all_papers_pdf(self, papers_directory):
        ...
        for folder in folders:
            ...
            folder_types = listdir(folder_in_year)
            if '.DS_Store' in folder_types:
                folder_types.remove('.DS_Store')

            for paper_type in folder_types:
                print(paper_type)
                current_folder = str(folder_in_year) + "/" + paper_type + "/"
                ...
                for file in files:
                    ...
                    self.papers.update({cleaned_paper_title: Paper(cleaned_paper_title, proceedings_year, paper_type, file)})
                    ...
                    for possible_section in possible_sections:
                        ...
                        if section_text.startswith("References") or section_text.startswith("references") or section_text.startswith("REFERENCES"):
